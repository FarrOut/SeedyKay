...
class EncryptedInstanceNestedStack(NestedStack):
    ...
    def __init__(self, scope: Construct, construct_id: str,
        ...
        #           )
        CfnOutput(self, 'InstancePrivateDnsName',
